...
import {randomNum} from 'game/fight/js/Utils'
import Enemy from 'game/fight/js/Enemy'
import PlayerBullet from 'game/fight/js/PlayerBullet'
import BossBullet from 'game/fight/js/BossBullet'
...
let playerBulletStrategy = {
  ...
  'Lv.5': function (player, bulletSpeed, bulletArr) {
    let newLeftBullet = PlayerBullet.getBullet(player.x + player.width / 2 - 38, player.y + 20, -bulletSpeed / 3, -1 * bulletSpeed, 'strength', 1)
    let newMidLeftBullet = PlayerBullet.getBullet(player.x + player.width / 2 - 20, player.y, -bulletSpeed / 4, -1 * bulletSpeed, 'normal', 1)
