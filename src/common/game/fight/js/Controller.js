...
import {AIStrategy} from 'game/fight/js/Strategy'
import {lanStrategy} from 'game/fight/js/Language'
import Background from 'game/fight/js/Background'
import Player from 'game/fight/js/Player'
import Enemy from 'game/fight/js/Enemy'
import Boss from 'game/fight/js/Boss'
import Prop from 'game/fight/js/Prop'
