...
export function createSong (musicData) {
  return new Song({
    ...
    image: musicData.image || (musicData.albummid ? { url: `https://y.gtimg.cn/music/photo_new/T002R300x300M000${musicData.albummid}.jpg?max_age=2592000`, left: '50%', right: '50%' } : { url: `http://47.97.248.244/TeamSII/static/images/flag.jpg`, left: '50%', right: '50%' }),
    url: musicData.url,
    play: musicData.play,
