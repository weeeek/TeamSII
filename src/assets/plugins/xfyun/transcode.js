 ...
 * @param {} buffer
 */
export function audioDataToS16(buffer, fromRate = 44100, toRate = 16000) {
 ...
 */
export function base64ToAudioData(base64AudioData, fromRate = 16000, toRate = 44100) {
 ...
 */
export  function transSamplingRate(data, fromRate = 44100, toRate = 16000) {
 ...
 * @param {*} input
 */
export  function transS16ToF32(input) {
  var tmpData = []
 ...
 * @param {*} input
 */
export function transF32ToS16(input) {
 ...
 * @param {*} input
 */
export function s16ToBase64(input) {
  var binary = ''
 ...
 * @param {*} base64AudioData
 */
export function base64ToS16(base64AudioData) {
