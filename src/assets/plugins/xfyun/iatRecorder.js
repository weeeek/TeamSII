...
import { APPID, API_KEY, API_SECRET } from "@/config/xfyun.js"
import TransWorker from '@/assets/plugins/xfyun/transcode.worker.js'
    ...
    recorderInit() {
        ...
        let getMediaSuccess = stream => {
            ...
            this.scriptProcessor.onaudioprocess = e => {
                // 去处理音频数据
                if (this.status === 'ing') {
                    self.postMessage(e.inputBuffer.getChannelData(0))
                }
            }
