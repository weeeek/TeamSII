<template>
  <div>
    ...
    <div class="block" v-if="memberDataList.length > 0">
    ...
    <div class="block" v-if="pet48DataList.length > 0">
    ...
    <div class="block" v-if="otherTeamMemberDataList.length > 0">
    ...
    <div class="block" v-if="exitMemberDataList.length > 0">
      <h2>十年后再回首，我们初心不改</h2>
      <div class="members">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      getPetPhoto (m) {
        return m.photo ? m.photo : `http://47.97.248.244/static/pet48/${m.name}.jpg`
      }
    }
  }
</script>
    ...
    .member
      ...
      .photo
        ...
        .association
          ...
          left calc(50% + 37.5px)
        .nine
          background-image url('http://47.97.248.244/static/images/the9.jpg')
        .group
          position absolute
          left calc(50% + 37.5px)
          border-radius 50%
