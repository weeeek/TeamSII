    ...
    <div class="playlist" @click="hide" v-show="showFlag">
      <div class="list-wrapper" @click.stop>
        ...
        <div class="list-header">
          <h1 class="title">
            <jam-repeat :fillColor="fillColor" v-show="this.mode == 1" @click="changeMode" />
            <jam-shuffle :fillColor="fillColor" v-show="this.mode == 2" @click="changeMode" />
            <jam-ordered-list :fillColor="fillColor" v-show="this.mode == 0" @click="changeMode" />
